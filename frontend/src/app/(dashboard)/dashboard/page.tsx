...
import { FileSearch, TrendingDown, CheckCircle2, ArrowUpRight, ArrowDownRight, Plus, BarChart3, Activity, Sparkles, Banknote, CalendarDays, Building2, Percent, Brain } from 'lucide-react'
