...
import { FileSearch, ArrowRight, Plus, Clock, AlertTriangle, CheckCircle2, FileText, TrendingDown, CalendarDays, Search, Filter } from 'lucide-react'
    ...
    <div className="animate-fade-in-up space-y-8">
      ...
      {!analyses || analyses.length === 0 ? (
        ...
        <div className="bg-white dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl border border-gray-100 dark:border-gray-800/40 shadow-sm overflow-hidden">
          <div className="hidden sm:grid grid-cols-[1fr_100px_90px_110px_100px_32px] gap-4 px-6 py-3 bg-gray-50/50 dark:bg-gray-800/20 border-b border-gray-100 dark:border-gray-800/30">
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-800/20">
            {analyses.map((analysis, i) => (
              <Link
                ...
                className="group flex flex-col sm:grid sm:grid-cols-[1fr_100px_90px_110px_100px_32px] gap-3 sm:gap-4 px-5 sm:px-6 py-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-all duration-200"
